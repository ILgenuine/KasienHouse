...
<div style="background-color: #f4f4f2;">
  <div class="container">
    ...
    <nav class="navbar navbar-expand-md nav-box navbar-light" data-aos="fade-up" data-aos-duration="1000" >
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav navbar-bottom">
          ...
          <li class="nav-item" data-aos="slide-up" data-aos-duration="1500" data-aos-delay="300">
            <a class="nav-link nav-link-responsive active-menu" href="index-remaster.php">หน้าแรก</a>
          </li>
          <li class="nav-item" data-aos="slide-up" data-aos-duration="1500" data-aos-delay="400">
            <a class="nav-link nav-link-responsive" href="about-us.php">เกี่ยวกับเรา</a>
          </li>
          <li class="nav-item" data-aos="slide-up" data-aos-duration="1500" data-aos-delay="500">
            <a class="nav-link nav-link-responsive" href="article.php">บทความ</a>
          </li>
          <li class="nav-item dropdown" data-aos="slide-up" data-aos-duration="1500" data-aos-delay="600">
          ...
          <li class="nav-item" data-aos="slide-up" data-aos-duration="1500" data-aos-delay="700">
            <a class="nav-link nav-link-responsive" href="portfolio_all.php">ผลงานทั้งหมด</a>
          </li>
          <li class="nav-item" data-aos="slide-up" data-aos-duration="1500" data-aos-delay="800">
            <a class="nav-link nav-link-responsive" href="contact.php">ติดต่อเรา</a>
          </li>
        </ul>
      </div>
    </nav>
