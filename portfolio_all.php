                ...
                <div style="margin: auto;margin-top: 25px;">
                  <nav aria-label="Page navigation example">
                    <ul class="pagination">
                      ...
                      <li class="page-item"><a class="page-link portfolio-all-borderradius" href="#">2</a></li>
                      <li class="page-item"><a class="page-link portfolio-all-borderradius" href="#">3</a></li>
                      <li class="page-item">
