                     ...
                     <button class="btn-slider nockdown-slider-button-prev home-btn-top-3" type="button"  id="prev">
                      ...
                      <section class="section-slider">
                          <ul class="carousel">
                            ...
                            <li class="items right-pos slider-li" id="2">
                              <div class="card-slider">
                                  <div class="card-header text-center">
                                    บ้านแบบโมเดิร์น
                                  </div>
                            ...
                            <li class="items back-pos slider-li" id="3">
                              <div class="card-slider">
                                  <div class="card-header text-center">
                                    บ้านแบบอังกฤษ
                                  </div>
                            ...
                            <li class="items back-pos slider-li" id="4">
                              <div class="card-slider">
                                  <div class="card-header text-center">
                                    บ้านแบบไทย
                                  </div>
...
s                                  </div>
                            ...
                            <li class="items back-pos slider-li" id="6">
                              <div class="card-slider">
                                  <div class="card-header text-center">
                                    บ้านแบบญี่ปุ่น
                                  </div>
                            ...
                            <li class="items left-pos slider-li" id="7">
                              <div class="card-slider">
                                  <div class="card-header text-center">
                                    บ้านแบบโมเดิร์น
                                  </div>
...
<!-- ========================= END SLIDER ================================================= -->
              ...
              <div class="container">
                <div class="row mb-5" data-aos="fade-up" data-aos-duration="1500">
                  ...
                  <div class="col-sm-12">
                    <div class="text-center text-purple home-title-top20"><h2>รูปแบบบ้านทั้งหมด</h2></div>
                  </div>
                </div>
                    ...
                    <div class="mx-3 mb-5">
                      <div class="card-nockdown">
                        ...
                        <div class="home-card-body">
                          <h5 class="card-title home-fix-title">รูปแบบบ้านโมร็อคโค</h5>
                          <div class="text-purple home-text-profile">
                            <p id="font-wight-350">Lorem Ipsum คือ เนื้อหาจำลองแบบเรียบๆ ที่ใช้กันในธุรกิจงานพิมพ์หรืองานเรียงพิมพ์</p>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div id="col-fix-home-responsive-2" class="col-12 col-sm-4">
                    <div class="mx-3 mb-5">
                      <div class="card-nockdown">
                        ...
                        <div class="home-card-body">
                          <h5 class="card-title home-fix-title">รูปแบบบ้านญี่ปุ่น</h5>
                          <div class="text-purple home-text-profile">
                            <p id="font-wight-350">Lorem Ipsum คือ เนื้อหาจำลองแบบเรียบๆ ที่ใช้กันในธุรกิจงานพิมพ์หรืองานเรียงพิมพ์</p>
                          </div>
                        </div>
                  ...
                  <div id="col-fix-home-responsive-2" class="col-12 col-sm-4">
                    <div class="mx-3 mb-5">
                      <div class="card-nockdown">
                        ...
                        <div class="home-card-body">
                          <h5 class="card-title home-fix-title">รูปแบบบ้านอังกฤษ</h5>
                          <div class="text-purple home-text-profile">
                            <p id="font-wight-350">Lorem Ipsum คือ เนื้อหาจำลองแบบเรียบๆ ที่ใช้กันในธุรกิจงานพิมพ์หรืองานเรียงพิมพ์</p>
                          </div>
                        </div>
                  ...
                  <div id="col-fix-home-responsive-2" class="col-12 col-sm-4">
                    <div class="mx-3 mb-5">
                      <div class="card-nockdown">
                        ...
                        <div class="home-card-body">
                          <h5 class="card-title home-fix-title">รูปแบบบ้านไทยประยุกต์</h5>
                          <div class="text-purple home-text-profile">
                            <p id="font-wight-350">Lorem Ipsum คือ เนื้อหาจำลองแบบเรียบๆ ที่ใช้กันในธุรกิจงานพิมพ์หรืองานเรียงพิมพ์</p>
                          </div>
                        </div>
                  ...
                  <div id="col-fix-home-responsive-2" class="col-12 col-sm-4">
                    <div class="mx-3 mb-5">
                      <div class="card-nockdown">
                        ...
                        <div class="home-card-body">
                          <h5 class="card-title home-fix-title">รูปแบบบ้านโมเดิร์น</h5>
                          <div class="text-purple home-text-profile">
                            <p id="font-wight-350">Lorem Ipsum คือ เนื้อหาจำลองแบบเรียบๆ ที่ใช้กันในธุรกิจงานพิมพ์หรืองานเรียงพิมพ์</p>
                          </div>
                        </div>
                  ...
                  <div id="col-fix-home-responsive-2" class="col-12 col-sm-4">
                    <div class="mx-3 mb-5">
                      <div class="card-nockdown">
                        ...
                        <div class="home-card-body">
                          <h5 class="card-title home-fix-title">รูปแบบอื่นๆ</h5>
                          <div class="text-purple home-text-profile">
                            <p id="font-wight-350">Lorem Ipsum คือ เนื้อหาจำลองแบบเรียบๆ ที่ใช้กันในธุรกิจงานพิมพ์หรืองานเรียงพิมพ์</p>
                          </div>
                        </div>
              ...
              <div class="home-py-5 home-backgroun-contact">
                ...
                <div class="container mb-5">
                  <div class="row mb-5 mt-5" data-aos="fade-up" data-aos-duration="1500">
                    ...
                    <div class="col-sm-12">
                      <div class="text-center text-purple home-title-top20"><h2>ติดต่อเรา</h2></div>
                    </div>
                  </div>
